...
[ $subdircount -gt 0 ] || (echo "external dependency not cloned properly, cloning submodules" && git submodule update --recursive)

echo "installing dependencies"
package=( "libx11-dev" "libgl-dev" "libpng-dev", "gnuplot")
